 ...
 */
@WebServlet(name = "IngressoServlet", urlPatterns = {"/ingressoservlet"})
public class IngressoServlet extends HttpServlet {
    
    @Inject
    IngressoBeanLocal ingressoBean;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Ingresso ingresso = new Ingresso(new BigDecimal(request.getParameter("valor")));
        
        ingressoBean.salvar(ingresso);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet IngressoServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Valor &lt;" + ingresso.getValor() + "&gt; adicionado com sucesso ao ingresso!</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
