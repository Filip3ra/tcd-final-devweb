...
public class HorarioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Horario horario = new Horario(LocalTime.parse(request.getParameter("horario"), formatter));
        
        horarioBean.salvar(horario);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Horario &lt;" + horario.getHorario() + "&gt; definido com sucesso!</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
