...
public class ArtistaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Artista artista = new Artista(request.getParameter("nome"));
        
        artistaBean.salvar(artista);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ArtistaServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Artista &lt;" + artista.getNome() + "&gt; cadastrado com sucesso!</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
