 ...
 */
package br.edu.ifnmg.web.idioma;
...
public class IdiomaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Idioma idioma = new Idioma(request.getParameter("idioma"));
        
        idiomaBean.salvar(idioma);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet IdiomaServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Idioma &lt;" + idioma.getIdioma() + "&gt; registrado com sucesso!</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
